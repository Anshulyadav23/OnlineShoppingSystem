...
<%@include file= "../shared/flows-header.jsp" %>
     ...
     <label class="control-label vol-lg-4">First Name</label>
     <div class="col-md-8">
     ...
     <div class="form-group">
     <label class="control-label vol-md-4">Last Name</label>
     <div class="col-md-8">
     ...
     <div class="form-group">
     <label class="control-label vol-md-4">E-mail</label>
     <div class="col-md-8">
     ...
     <sf:errors path="email" cssClass="help-block"  element="em"/>
       ...
       <div class="form-group">
     <label class="control-label vol-md-4">Contact Number</label>
     <div class="col-md-8">
     ...
     <div class="form-group">
     <label class="control-label vol-md-4">Password</label>
     <div class="col-md-8">
     ...
     <div class="form-group">
     <label class="control-label vol-md-4">Confirm Password</label>
     <div class="col-md-8">
     ...
     <!--  radio button using bootstrap class of radio-in line -->
       <div class="form-group">
     <label class="control-label vol-md-4">Select Role</label>
     <div class="col-md-8">
